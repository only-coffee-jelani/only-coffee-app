...
export class UpdateSplashScreenDto {
  ...
  @ApiPropertyOptional({ description: 'UUID of the image asset', example: '9b252f8e-b531-43c9-93e0-ae72a6a3e3fa' })
  @IsOptional()
  @IsUUID()
  imageAssetId?: string;

  @ApiPropertyOptional({ description: 'Duration in seconds', example: 3, minimum: 1, maximum: 10 })
  @IsOptional()
  @IsInt()
  @Min(1)
  @Max(10)
  ...
  @ApiPropertyOptional({ description: 'Whether the splash screen is active', example: true })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;

  @ApiPropertyOptional({ description: 'Priority (higher = shown first)', example: 0 })
  @IsOptional()
  @IsInt()
  priority?: number;
