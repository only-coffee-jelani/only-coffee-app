...
exports.InitialSchema1701388800000 = void 0;
class InitialSchema1701388800000 {
    constructor() {
        this.name = 'InitialSchema1701388800000';
    }
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_stores_location" ON "stores" ("latitude", "longitude")`);
        await queryRunner.query(`
      CREATE TABLE "orders" (
    ...
    `);
      ...
      `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_orders_storeId_createdAt" ON "orders" ("storeId", "createdAt")`);
        await queryRunner.query(`
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_order_items_menuItemId" ON "order_items" ("menuItemId")`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_menu_items_storeId" ON "menu_items" ("storeId")`);
        await queryRunner.query(`CREATE INDEX "IDX_menu_items_category" ON "menu_items" ("category")`);
        await queryRunner.query(`CREATE INDEX "IDX_menu_items_toastItemId" ON "menu_items" ("toastItemId")`);
        await queryRunner.query(`
    ...
    `);
      ...
      `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_rewards_ledger_userId" ON "rewards_ledger" ("userId")`);
        await queryRunner.query(`CREATE INDEX "IDX_rewards_ledger_transactionType" ON "rewards_ledger" ("transactionType")`);
        await queryRunner.query(`CREATE INDEX "IDX_rewards_ledger_userId_createdAt" ON "rewards_ledger" ("userId", "createdAt")`);
        await queryRunner.query(`
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_gift_cards_senderUserId" ON "gift_cards" ("senderUserId")`);
        await queryRunner.query(`CREATE INDEX "IDX_gift_cards_recipientUserId" ON "gift_cards" ("recipientUserId")`);
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_delivery_orders_orderId" ON "delivery_orders" ("orderId")`);
        await queryRunner.query(`CREATE INDEX "IDX_delivery_orders_provider" ON "delivery_orders" ("provider")`);
        await queryRunner.query(`CREATE INDEX "IDX_delivery_orders_status" ON "delivery_orders" ("status")`);
        await queryRunner.query(`
...
exports.InitialSchema1701388800000 = InitialSchema1701388800000;
//# sourceMappingURL=1701388800000-InitialSchema.js.map