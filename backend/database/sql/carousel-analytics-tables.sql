-- =====================================================================
-- CAROUSEL ANALYTICS TABLES
-- Enterprise-level analytics infrastructure for carousel tracking
-- =====================================================================
...
DO $$
BEGIN
  RAISE NOTICE '🎉 Carousel analytics tables created successfully!';
  RAISE NOTICE '✅ carousel_events - Raw event tracking';
  RAISE NOTICE '✅ carousel_sessions - Session engagement tracking';
  RAISE NOTICE '✅ carousel_daily_aggregates - Pre-computed daily metrics';
  RAISE NOTICE '✅ carousel_ab_tests - A/B testing framework';
  RAISE NOTICE '✅ carousel_position_performance - Position-based analytics';
END $$;
